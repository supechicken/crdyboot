...
#[repr(C, packed)]
struct boot_params {
    screen_info: [u8; 64usize],
    apm_bios_info: [u8; 20usize],
    _pad2: [u8; 4usize],
    tboot_addr: u64,
    ist_info: [u8; 16usize],
    _pad3: [u8; 16usize],
    hd0_info: [u8; 16usize],
    hd1_info: [u8; 16usize],
    sys_desc_table: [u8; 16usize],
    olpc_ofw_header: [u8; 16usize],
    ext_ramdisk_image: u32,
    ext_ramdisk_size: u32,
    ext_cmd_line_ptr: u32,
    _pad4: [u8; 116usize],
    edid_info: [u8; 128usize],
    efi_info: [u8; 32usize],
    alt_mem_k: u32,
    scratch: u32,
    e820_entries: u8,
    ...
    hdr: setup_header,
    _pad7: [u8; 40usize],
    edd_mbr_sig_buffer: [u32; 16usize],
    e820_table: [u8; 2560usize],
    _pad8: [u8; 48usize],
    eddbuf: [u8; 492usize],
    _pad9: [u8; 276usize],
}
